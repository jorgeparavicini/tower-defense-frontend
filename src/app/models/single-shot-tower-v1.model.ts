...
export interface SingleShotTowerModelV1 {
...
export class SingleShotTowerV1 implements Structure {
  id: number;
  pos: Coord;
  health: number;
  model: string;
  ...
  dataModel: SingleShotTowerModelV1;
  ...
  constructor(data: any, structures: Map<String, StructureModel>) {
    ...
    this.dataModel = structures.get(this.model) as any as SingleShotTowerModelV1;
